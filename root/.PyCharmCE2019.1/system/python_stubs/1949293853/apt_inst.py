...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fa8455fbb38>'

__spec__ = None # (!) real value is "ModuleSpec(name='apt_inst', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fa8455fbb38>, origin='/usr/lib/python3/dist-packages/apt_inst.cpython-35m-x86_64-linux-gnu.so')"
