...
executable = '/root/PycharmProjects/dev/venv/bin/python'

exec_prefix = '/root/PycharmProjects/dev/venv'
...
prefix = '/root/PycharmProjects/dev/venv'
...
implementation = None # (!) real value is "namespace(_multiarch='x86_64-linux-gnu', cache_tag='cpython-35', hexversion=50660080, name='cpython', version=sys.version_info(major=3, minor=5, micro=2, releaselevel='final', serial=0))"
...
path = [
    '/root/.local/share/umake/ide/pycharm/helpers',
    '/root/catkin_build_ws/install/lib/python3/dist-packages',
    ...
    '/root/PycharmProjects/dev/venv/lib/python3.5/site-packages',
...
path_hooks = [
    ...
    None, # (!) real value is '<function FileFinder.path_hook.<locals>.path_hook_for_FileFinder at 0x7f6344da9950>'
]
...
stdin = None # (!) real value is "<_io.TextIOWrapper name='<stdin>' mode='r' encoding='UTF-8'>"
