...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f0a0c3d2b70>'

__spec__ = None # (!) real value is "ModuleSpec(name='_ssl', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f0a0c3d2b70>, origin='/usr/lib/python3.5/lib-dynload/_ssl.cpython-35m-x86_64-linux-gnu.so')"
