# encoding: utf-8
# module _curses
# from /usr/lib/python3.5/lib-dynload/_curses.cpython-35m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
_C_API = None # (!) real value is '<capsule object "_curses._C_API" at 0x7fbcd6bf94b0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fbcd711db70>'

__spec__ = None # (!) real value is "ModuleSpec(name='_curses', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fbcd711db70>, origin='/usr/lib/python3.5/lib-dynload/_curses.cpython-35m-x86_64-linux-gnu.so')"
