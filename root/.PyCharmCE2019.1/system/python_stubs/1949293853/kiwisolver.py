# encoding: utf-8
# module kiwisolver
# from /usr/local/lib/python3.5/dist-packages/kiwisolver.cpython-35m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
strength = None # (!) real value is '<kiwisolver.strength object at 0x7fd3f8aa7100>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3f7eaab38>'

__spec__ = None # (!) real value is "ModuleSpec(name='kiwisolver', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd3f7eaab38>, origin='/usr/local/lib/python3.5/dist-packages/kiwisolver.cpython-35m-x86_64-linux-gnu.so')"
